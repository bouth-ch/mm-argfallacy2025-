"""
CLI: wavlm_roberta_afc_focal (Focal Loss + WeightedRandomSampler).

From project root:
    python scripts/run_wavlm_roberta_afc_focal.py

Background:
    nohup python scripts/run_wavlm_roberta_afc_focal.py > logs/wavlm_roberta_afc_focal.log 2>&1 &
"""
import sys
...
from src.configs.multimodal_configs import get_wavlm_roberta_afc_focal_config
...
config = get_wavlm_roberta_afc_focal_config()
