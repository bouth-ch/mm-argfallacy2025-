"""
CLI: wavlm_roberta_afd (CrossEntropy pondérée).

From project root:
    python scripts/run_wavlm_roberta_afd.py

Background:
    nohup python scripts/run_wavlm_roberta_afd.py > logs/wavlm_roberta_afd.log 2>&1 &
"""
import sys
...
from src.configs.multimodal_configs import get_wavlm_roberta_afd_config
...
config = get_wavlm_roberta_afd_config()
